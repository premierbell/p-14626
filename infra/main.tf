...
CREATE USER 'applocal'@'127.0.0.1' IDENTIFIED WITH caching_sha2_password BY '1234';
CREATE USER 'applocal'@'172.18.%.%' IDENTIFIED WITH caching_sha2_password BY '1234';
CREATE USER 'appuser'@'%' IDENTIFIED WITH caching_sha2_password BY 'lldj123414';

GRANT ALL PRIVILEGES ON *.* TO 'applocal'@'127.0.0.1';
GRANT ALL PRIVILEGES ON *.* TO 'applocal'@'172.18.%.%';
...
output "ec2_instance_id" {
  ...
  description = "EC2 인스턴스 ID (GitHub Actions에서 사용)"
}